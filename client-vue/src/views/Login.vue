      ...
      <div class="p-10 xs:p-0 mx-auto md:w-full md:max-w-md">
        <div class="bg-white shadow w-full rounded-lg divide-y divide-gray-200">
          <form class="px-5 py-7" @submit.prevent="login">
            ...
            <div>
              <button type="submit" class="flex w-full justify-center rounded-md bg-indigo-600 mt-5 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Sign in</button>
            </div>
          </form>
          ...
          <p class="py-3 text-center text-sm/6 text-gray-500">
            Not a member?
            {{ ' ' }}
            <RouterLink class="font-semibold text-indigo-600 hover:text-indigo-500" to="/register">Register</RouterLink>
          </p>
        </div>
      </div>
    </div>
